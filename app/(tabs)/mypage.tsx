        ...
        <View style={styles.content}>
          ...
          <View style={styles.primaryBox}>
            ...
            <View style={styles.nicknameContainer}>
              <HeadingM color={colors.black}>김철수</HeadingM>
            ...
            <View style={styles.infoSection}>
              ...
              <BodyL color={colors.black} style={styles.infoValue}>서울시 강남구</BodyL>
            </View>

            {/* Language */}
            <View style={styles.infoSection}>
              <LabelS color={colors.black}>Language</LabelS>
              <BodyL color={colors.black} style={styles.infoValue}>한국어, English</BodyL>
            </View>
          </View>
